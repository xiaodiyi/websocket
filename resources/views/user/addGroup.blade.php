...
<div class="layui-container">
    <div class="layui-row">
        <div class="layui-col-md12">
            <form class="layui-form layui-form-pane" action="{{URL::asset('gechat/chatuser/addGroup'.'/'.$group->id)}}" method="post">
                {{csrf_field()}}
                <input type="hidden" name="form-target-groupId" value="{{$group->id}}">
                <input type="hidden" name="form-target-groupName" value="{{$group->group_name}}">
                <div class="layui-form-item">
                    <div style="float: left;width: 30%;text-align: center">
                        <img src="{{$group->group_avatar}}" width="100px" height="100px" class="layui-circle" style="margin-top: 20px;" />
                        <h5 style="margin-top: 10px">{{$group->group_name}}</h5>
                    </div>
