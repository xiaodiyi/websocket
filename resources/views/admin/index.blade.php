...
<head>
	...
	<!-- load css -->
	<link rel="stylesheet" type="text/css" href="{{URL::asset('geekclouds/common/layui/css/layui.css')}}" media="all">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('geekclouds/common/global.css')}}" media="all">
	<link rel="stylesheet" type="text/css" href="{{URL::asset('geekclouds/css/adminstyle.css')}}" media="all">
...
<!-- 加载js文件-->                                                                                                                                                                                           
	<script type="text/javascript" src="{{URL::asset('geekclouds/common/layui/layui.js')}}"></script>
	<script type="text/javascript" src="{{URL::asset('geekclouds/js/larry.js')}}"></script>
	<script type="text/javascript" src="{{URL::asset('geekclouds/js/index.js')}}"></script>
<!-- 锁屏 -->
